...
get_filename_component(_filename "/home/stavrow/ros_threads/catkin_ws/src/ros_threads/srv/GiveTime.srv" NAME_WE)
add_custom_target(_ros_threads_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_threads" "/home/stavrow/ros_threads/catkin_ws/src/ros_threads/srv/GiveTime.srv" ""
)
...
_generate_srv_cpp(ros_threads
  "/home/stavrow/ros_threads/catkin_ws/src/ros_threads/srv/GiveTime.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(ros_threads
  "/home/stavrow/ros_threads/catkin_ws/src/ros_threads/srv/GiveTime.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_threads
)

### Generating Module File
_generate_module_nodejs(ros_threads
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_threads
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(ros_threads_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(ros_threads_generate_messages ros_threads_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/stavrow/ros_threads/catkin_ws/src/ros_threads/srv/GiveTime.srv" NAME_WE)
add_dependencies(ros_threads_generate_messages_nodejs _ros_threads_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ros_threads_gennodejs)
add_dependencies(ros_threads_gennodejs ros_threads_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ros_threads_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_threads)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_threads
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(ros_threads_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
